...
|---------|-----------|
| 1.0.x | âœ… Active |
| < 1.0 | âŒ No longer supported |

## Reporting a Vulnerability

**Please do NOT open a public GitHub issue for security vulnerabilities.**

If you discover a security vulnerability in Morphix, please report it responsibly:

1. **Email**: Send details to `security@morphix.com` (replace with your actual email)
